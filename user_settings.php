...
<head>
    ...
    <script>
        ...
        function delete_sensor(sensor_name) {
            ...
            xmlhttp.open("GET", "../api/ajax/delete_user_sql.php?q=" + sensor_name + "&user_login=" + user_login, true);
            xmlhttp.send();
...
<body>
    ...
    <div class="content ">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 col-lg-2 d-none d-md-inline " style=" min-height: calc(100vh - 106px);">
            ...
            <div class="col-11 col-md-8 p-2 p-md-4 h-100 ">
                <div class="row">
                    ...
                    <div class="d-none" id="sesnors_list_id">
                        <?php include("components/comp_sensors.php"); ?>
                    </div>
